...
<body class="font-dmsans">
    <section class="signup-container  h-dvh flex items-center flex-col justify-center">
        <section class="min-w-[500px] relative z-10 ">
            ...
            <form class="bg-white py-10 px-6 rounded-2xl" method="POST" action="./signup">
                ...
                <input required class="bg-slate-50 px-4 py-2 block w-full mb-6 rounded-md border-[1px] border-slate-200" placeholder="enter password" name="password" class="block" />

                <label class="block font-semibold text-slate-700 mb-2">Confirm Password</label>
                <input type="password" required class="bg-slate-50 px-4 py-2 block w-full mb-10 rounded-md border-[1px] border-slate-200" placeholder="confirm password" name="password2" class="block" />
