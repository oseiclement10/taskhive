...
<body class="font-dmsans ">
    <main class="h-dvh  bg-[#fdfaf3b3] py-10 relative main-bg">
        <nav class="bg-white relative w-5/6 mx-auto rounded-3xl px-6 flex  items-center justify-between py-3 shadow-sm">
        ...
        <section class="relative flex flex-col items-center justify-center mt-14 ">
            <h1 class="text-6xl tracking-wide w-4/6 font-bold text-center mb-6">
        ...
        <div class="bg-gradient-to-r text-white from-black via-black/90 to-black w-fit px-6 py-2 shadow-sm rounded-md absolute bottom-10 right-10">
