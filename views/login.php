<?php
$pageTitle = "Login | TaskHive";
require "header.php";
?>

<body class="font-dmsans">
    <section class="login-container  h-dvh flex items-center flex-col justify-center">
        <section class="min-w-[500px] relative z-10 ">
            ...
            <form class="bg-white py-10 px-6 rounded-2xl" method="POST" action="./login">
                <h2 class="text-3xl font-semibold text-center mb-8">Sign in to your account</h2>
                ...
                <button class="w-full bg-black rounded-md text-white px-4 text-center py-2 hover:opacity-90 active:opacity-30">Log in to your account </button>
