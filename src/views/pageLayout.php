...
<body class="font-dmsans grid grid-cols-6 min-h-dvh ">
    <aside class="col-span-1 bg-white h-full px-8 pt-5 ">
        ...
        <div class="py-4 pl-2 space-y-6">
            ...
            <a href="/taskhive/usr/tasks " class="text-lg  <?php echo matchesUrlEndPath("/tasks") ? 'text-slate-800' : 'text-gray-600'; ?>  group flex hover:text-amber-300">
            ...
            <a href="/taskhive/usr/profile " class="text-lg  <?php echo matchesUrlEndPath("/profile") ? 'text-slate-800' : 'text-gray-600'; ?>  group flex hover:text-amber-300">
