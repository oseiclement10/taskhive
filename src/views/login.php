    ...
    <section class="login-container  h-dvh flex items-center flex-col justify-center">
        <section class="min-w-[500px] relative z-10 ">
            ...
            <form class="bg-white py-10 px-10 rounded-2xl" method="POST" action="./login">
                ...
                <input class="bg-slate-50 px-4 py-2 block w-full mb-6 rounded-md border-[1px] border-slate-200" placeholder="enter email" name="email" value="<?php echo getFormValue(("email")) ?>" />
